import { Box, Button, Card, CardBody, CardFooter, CardHeader, Center, Divider, grid, GridItem, Heading, HStack, Image, Text, VStack } from '@chakra-ui/react';
import { UilBath, UilBed, UilBox, UilCar, UilPercentage } from '@iconscout/react-unicons';
